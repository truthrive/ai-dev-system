...
- Phase 1 repository foundation with version `0.1.0-dev`.
- Concise agent entrypoint, central documentation router, and ten-principle constitution.
- Directory placeholders for architecture, decisions, rules, skills, workflows, gates, templates, installer, and tests.
- Milestone roadmap covering the core operating model, enforcement and onboarding, real-project validation, and v1.0 distribution.
