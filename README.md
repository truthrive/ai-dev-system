...
**Status: early development (`0.1.0-dev`).** Phase 1 provides the repository structure, constitution, and documentation routing only. Rules, skills, workflows, executable quality gates, templates, installer, and tests are not implemented yet.
...
- **Temporary task state:** the current intent, specification, plan, tasks, and verification evidence. Its storage and retention conventions are not defined in Phase 1.
